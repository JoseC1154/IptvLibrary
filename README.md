...
-The channel up and down feature should cycle through the filtered channels on display.
-when cycling through the channels the aspect and proportions should maintain if there is a channel currently playing. that holds true to channels being selected from the filtered group if a stream is being played.
